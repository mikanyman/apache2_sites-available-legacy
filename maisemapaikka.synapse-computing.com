<VirtualHost *:80>
        ...
        ServerName maisemapaikka.synapse-computing.com
        ...
        WSGIDaemonProcess maisemapaikka.synapse-computing.com user=mnyman group=mnyman processes=2 threads=15 display-name=%{GROUP}
        WSGIProcessGroup maisemapaikka.synapse-computing.com

        # ---------- Filestore ----------
        WSGIScriptAlias /filestore /home/mnyman/.virtualenvs/maisemapaikka/filestore/apache/django.wsgi
        <Directory /home/mnyman/.virtualenvs/maisemapaikka/filestore/apache>
                Order deny,allow
                Allow from all
        </Directory>

        WSGIScriptAlias / /home/mnyman/.virtualenvs/maisemapaikka/production/maisemapaikka/apache/django.wsgi
        <Directory /home/mnyman/.virtualenvs/maisemapaikka/production/maisemapaikka/apache>
                Order deny,allow
                Allow from all
        </Directory>
